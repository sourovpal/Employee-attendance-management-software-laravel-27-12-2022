                ...
                <form action="{{route('employee.update', ['id' => $user->id ])}}" method="post">
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col">
                                <label for="input-8">Civil Status</label>
                                <select class="form-control {{$errors->has('civil')?'is-invalid':''}}" name="civil">
                                    <option value="">CHOOSE</option>
                                    <option @if($user->civil == 'single') selected @endif value="single">Single</option>
                                    <option @if($user->civil == 'married') selected @endif  value="married">Married</option>
                                </select>
